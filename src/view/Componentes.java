...
public class Componentes extends JPanel {
    ...
    public Componentes() {
        ...
        addd = new JButton("Tabla");
        addd.setBackground(Color.WHITE);
        addd.setForeground(Color.BLACK);
        addd.setFocusable(false);
        addd.addActionListener(control);
        GridBagConstraints gbcAddd = new GridBagConstraints();
        gbcAddd.insets = new Insets(0, 0, 5, 5);
        gbcAddd.gridx = 2;
        gbcAddd.gridy = 0;
        gbcAddd.anchor = GridBagConstraints.NORTH;
        aux.add(addd);
